...
@class BasePageControlViewConfig;

@interface BasePageControlView : UIView
@property (nonatomic, retain) BasePageControlViewConfig* pageControlViewConfig;
 ...
 */
@interface BasePageControlViewConfig : NSObject
