...
-(id)initWithFrame:(CGRect)frame withPhotoUrl:(NSString *)photoUrl{
    ...
    if (self) {
        ...
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",photoUrl,SUOLUE_PIC_1000]] placeholderImage:DefaultPlaceHolderSquarePlus options:SDWebImageDelayPlaceholder progress:^(NSInteger receivedSize, NSInteger expectedSize){
