...
#define weakSelf(var)   __weak __typeof(var) weakSelf = var;
#define strongSelf(var) __strong __typeof(var) strongSelf = var;
...
#define FSBLUECOLOR RGB(52, 169, 229)
#define FSDISBLUECOLOR RGB(52, 169, 229)
#define CZJBLUECOLOR RGB(44, 148, 255)
#define CZJREDCOLOR RGB(251, 70, 78)
#define CZJGRAYCOLOR RGB(200, 200, 200)
