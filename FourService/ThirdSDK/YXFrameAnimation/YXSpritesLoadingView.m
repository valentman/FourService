...
//        }
    ...
    loaderView.alpha = 0;
    loaderView.transform = CGAffineTransformScale(loaderView.transform, 1.0, 1.0);
...
- (NSArray *)imagesForAnimating
{
    ...
    {
        [retVal addObject:[UIImage imageNamed:[NSString stringWithFormat:@"%@%d",spriteNameString, i+1]]];
    }
    return retVal;
}
