...
@interface FSCityLocationController ()
<UIGestureRecognizerDelegate,
UISearchBarDelegate,
UITextFieldDelegate,
ButtonGroupViewDelegate,
UITableViewDelegate,
...
@implementation FSCityLocationController
...
- (void)ininHeaderView
{
    ...
    _tableHeaderView.frame = CGRectMake(0, 0, self.tableView.frame.size.width, _hotCityGroupView.frame.origin.y+_hotCityGroupView.frame.size.height);
    self.tableView.tableHeaderView.frame = _tableHeaderView.frame;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.tableView respondsToSelector:@selector(setSectionIndexColor:)]) {
        self.tableView.sectionIndexBackgroundColor = KSectionIndexBackgroundColor;  //修改索引试图未选中时的背景颜色
        self.tableView.sectionIndexTrackingBackgroundColor = kSectionIndexTrackingBackgroundColor;//修改索引试图选中时的背景颜色
        self.tableView.sectionIndexColor = kSectionIndexColor;//修改索引试图字体颜色
    }
...
#pragma mark- ButtonGroupViewDelegate
