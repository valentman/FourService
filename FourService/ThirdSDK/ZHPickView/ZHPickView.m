...
//    _toolbar.tintColor  = [UIColor blueColor];
    ...
    CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
    UIImageView* tst = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"pop.png"]];
    tst.frame=CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, 320);
    [self addSubview:tst];
    
    UIButton* lLeft = [UIButton buttonWithType:UIButtonTypeSystem];
    [lLeft setTitle:@"取消" forState:UIControlStateNormal];
    [lLeft setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    lLeft.titleLabel.font = [UIFont systemFontOfSize:14.0f];
    [lLeft.titleLabel setTextColor:[UIColor blackColor]];
    [lLeft addTarget:self action:@selector(remove) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:lLeft];
    lLeft.frame = CGRectMake(10, 10, 40, 30);

    
    UIButton* lRight = [UIButton buttonWithType:UIButtonTypeSystem];
    [lRight setTitle:@"确定" forState:UIControlStateNormal];
    lRight.titleLabel.font = [UIFont systemFontOfSize:14.0f];
    [lRight setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [lRight addTarget:self action:@selector(doneClick) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:lRight];
    lRight.frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 55, 10, 40, 30);
...
////    [toolbar setBackgroundImage:[UIImage new]forToolbarPosition:UIBarPositionAny
...
////    
////    UIBarButtonItem *right=[[UIBarButtonItem alloc] initWithTitle:@"Done" style:UIBarButtonItemStylePlain target:self action:@selector(doneClick)];
////    toolbar.items=@[lefttem,centerSpace,right];
////    return toolbar;
//}
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, 5,[UIScreen mainScreen].bounds.size.width, ZHToobarHeight);
}
